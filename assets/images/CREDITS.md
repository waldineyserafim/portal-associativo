...
| `hero/hero-diretoria-*` | [pexels.com/photo/3753009](https://www.pexels.com/photo/elderly-people-sitting-at-table-with-laptop-3753009/) | Andrea Piacquadio ([@olly](https://www.pexels.com/@olly/)) — licença Pexels, uso comercial livre | `index_nova.html` — Hero (proposta de nova Home): diretoria madura reunida em volta de um notebook, parede terracota, luz natural — personas reais 50+ (Creative Direction §4.1) usando tecnologia com naturalidade. Contraste do texto sobreposto verificado por cálculo sobre os pixels (ver `css/landing-nova.css`) |
